...
# Exp dirs
cfg.EXP_NAME          = ''
cfg.EXP_ROOT          =  '/mnt/workdir/fengwei/ultra_wide/DAUDA_IMAGE/mspcl/scripts/experiments'
...
cfg.TRAIN.CLASS_CENTER_FEA_INIT_SRC = ''
cfg.TRAIN.CLASS_CENTER_FEA_INIT_TRG = ''
...
cfg.TRAIN.consistency = 0.1
cfg.TRAIN.consistency_type = "mse"
cfg.TRAIN.consistency_rampup = 40.0
